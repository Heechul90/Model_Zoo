...
net = vision.vgg11(classes=10, pretrained=False, ctx=ctx)
# net = vision.vgg11_bn(classes=10, pretrained=False, ctx=ctx)
# net = vision.vgg13(classes=10, pretrained=False, ctx=ctx)
# net = vision.vgg13_bn(classes=10, pretrained=False, ctx=ctx)
# net = vision.vgg16(classes=10, pretrained=False, ctx=ctx)
# net = vision.vgg16_bn(classes=10, pretrained=False, ctx=ctx)
# net = vision.vgg19(classes=10, pretrained=False, ctx=ctx)
# net = vision.vgg19(classes=10, pretrained=False, ctx=ctx)
